      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        <ScrollReveal className="text-center mb-20">
          ...
          <p className="text-gray-400 text-lg max-w-3xl mx-auto leading-relaxed mb-4">
            NaierStore menyediakan akses mudah ke Cloud Gaming dan Aplikasi Premium berkualitas tinggi.
            Kami menawarkan berbagai layanan cloud gaming terlengkap dengan performa maksimal, serta jual aplikasi premium populer seperti Netflix, Spotify, ChatGPT Plus, dan banyak lagi dengan harga terjangkau.
          </p>
          <p className="text-gray-400 text-lg max-w-2xl mx-auto leading-relaxed">
            Semua layanan didesain untuk memberikan pengalaman terbaik dengan server stabil, proses cepat, dan customer support terpercaya.
          </p>
        </ScrollReveal>
